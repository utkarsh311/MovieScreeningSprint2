...
public class MovieScreeningServiceImplTest {
	...
	private List<MovieSchedule> allMovies = null;
    ...
    public void updateMovieScheduleSucces()
    {
       ...
       movieSchedule.setActors("srk");
       MovieSchedule saveMovie=movieScreeningServiceImpl.updateMovieSchedule(movieSchedule.getEmail(), movieSchedule);
